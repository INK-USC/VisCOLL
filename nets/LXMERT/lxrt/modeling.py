...
class LXRTPretraining(BertPreTrainedModel):
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, masked_lm_labels=None,
                visual_feats=None, pos=None, obj_labels=None, matched_label=None, ans=None, reduce=True):
        ...
        return total_loss, torch.stack(losses).unsqueeze(0), lang_prediction_scores.detach()
